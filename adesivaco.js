/* ===========================================================
   Card de Adesivaço — geometria e desenho
   Medidas do Figma: "DA Mídia — MR 2026", CARD-ADESIVAÇOS (2050:32).
...
export function plano(g, c) {
  ...
  itens.push({ t: 'texto', id: 'titulo', linhas: ['ADESIVAÇO'], k: 'titulo', cor: c.titulo.cor,
...
export const inicial = () => ({
  ...
  vinte2:      { cor: '#00B0FF' },
  bloco:       { cor: '#FAFAFA' },
  cidade:      { txt: 'JI-PARANÁ', cor: '#1547A9', fonte: 'Encode Sans Semi Condensed' },
  ...
  local:       { txt: 'EM FRENTE AO GERIVALDÃO, CENTRO', cor: '#1547A9' },
